<!-- Modal Hapus -->
@foreach ($pengarsipanperalatan as $item)
    <div class="modal fade" id="approve_pengarsipan{{ $item->id_peralatan }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body ml-2 mr-2">
                    <form action="/pengarsipan/{{ $item->id_peralatan }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <p class="mt-3">Approve pengajuan pengarsipan dokumen {{ $item->nama_peralatan }} ?</p>
