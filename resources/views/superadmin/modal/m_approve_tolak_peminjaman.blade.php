...
@foreach ($peralatan as $item)
    <div class="modal fade" id="tolak_peminjaman{{ $item->id }}" tabindex="-1" role="dialog"
        aria-labelledby="delete_box" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title text-white" id="id">Tolak Cuti Karyawan</h5>
                    <button type="button" class="close text-white" data-bs-dismiss="modal"
                        aria-hidden="true">&times;</button>
                </div>
                <div class="modal-body">
                    Tolak pengajuan Cuti {{ $item->name }} ?
                </div>
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-primary" type="submit">Tolak Cuti</button>
    </div>
</form>
